...
- `13-12_专业制图与建模质量基准.md`
- `workers/cad/t0b_v2/VIEW_CONTRACT.md`
- `workers/cad/t0b_v2/geometry.py`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-resolved-local-assembly.json`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/geometry-manifest.json`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/eaveDetail.view-geometry.json.gz`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/bracketDetail.view-geometry.json.gz`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/columnBaseDetail.view-geometry.json.gz`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/doorWindowDetail.view-geometry.json.gz`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/detail-verification.json`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/geometry-verification.json`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/drawing-package-artifacts/sheet-output-verification.json`
- `验证材料/06_T0_CAD可行性验证/T0B_L1验收撤销记录.md`
- `验证材料/06_T0_CAD可行性验证/T0_CAD可行性与质量验证报告.md`
- `验证材料/06_T0_CAD可行性验证/外部DWG参照检查_寺庙古建筑设计方案图.md`
- `验证材料/06_T0_CAD可行性验证/外部参考_一套完整的古建施工图_只读审查.md`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-blender-preview.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-roof-side-preview.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/previews/t0b-v2-eaveDetail-clean.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/previews/t0b-v2-bracketDetail-clean.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/previews/t0b-v2-columnBaseDetail-clean.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/details/previews/t0b-v2-doorWindowDetail-clean.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/drawing-package-artifacts/independent-review/T0B-01-review-full.png`
- `验证材料/06_T0_CAD可行性验证/t0b-v2-outputs/drawing-package-artifacts/independent-review/T0B-02-review-full.png`
