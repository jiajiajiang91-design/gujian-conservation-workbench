  ...
  const taskDefinition = {
    ...
    artifactRequirements: {
      ...
      views: [
        ...
        { key: "axon", displayLabelZh: "轴测示意", drawingRef: "D-01-4", kind: "axonometric", scaleDenominator: 50, sheetKey: "sheet-a2", viewportRectMm: [314, 20, 260, 175], direction: [0.5773502691896258, 0.5773502691896258, -0.5773502691896258], right: [0.7071067811865476, -0.7071067811865476, 0], up: [0.4082482904638631, 0.4082482904638631, 0.8164965809277261], targetStableKeys: representative, sourceEvidenceRefs: [] },
