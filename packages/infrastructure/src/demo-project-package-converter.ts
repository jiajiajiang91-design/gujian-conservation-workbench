  ...
  const taskDefinition = {
    ...
    artifactRequirements: {
      ...
      views: [
        ...
        { key: "transverse", displayLabelZh: "横剖示意", drawingRef: "D-02-1", kind: "transverseSection", scaleDenominator: 75, sheetKey: "sheet-a3", viewportRectMm: [15, 150, 185, 125], direction: [1, 0, 0], right: [0, 1, 0], up: [0, 0, 1], sectionPlane: { normal: [1, 0, 0], offsetMm: 0 }, targetStableKeys: representative, sourceEvidenceRefs: [] },
        { key: "longitudinal", displayLabelZh: "纵剖示意", drawingRef: "D-02-2", kind: "longitudinalSection", scaleDenominator: 75, sheetKey: "sheet-a3", viewportRectMm: [220, 150, 185, 125], direction: [0, 1, 0], right: [1, 0, 0], up: [0, 0, 1], sectionPlane: { normal: [0, 1, 0], offsetMm: 0 }, targetStableKeys: representative, sourceEvidenceRefs: [] },
