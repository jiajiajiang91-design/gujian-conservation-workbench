...
- **展示阶段（当前）**：验收对象是从任务书到交付包的完整链路，每个环节有真实产出，可对外展示，服务求职与商业演示。验收标准为 `04_演示项目定义.md` v2.0 第 2 节基本要求与第 6 节演示矩阵；演示数据复用验证样本，不另造数据（4.4 节演示依赖）。
...
- 演示：产品对外展示使用的项目、选择依据与演示路径见 `04_演示项目定义.md`，演示数据复用验证样本，不另造数据。
