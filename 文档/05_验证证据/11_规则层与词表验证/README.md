...
本目录记录 PRD 线四个提交单元（声明式规则层、多方案停靠、受控词表、形制参数层）的验证证据。依据 `03_核心PRD_古建保护成果工作台.md` v1.3 的 R012 至 R014 与 `07_技术架构_古建保护成果工作台.md` v1.4 的 5.5 至 5.7 节。验证日期 2026-08-16，分支 codex/professional-workbench-rebuild。
